...
(function($) {
  ...
  var methods = {
      ...
      init : function(options) {
        ...
        if(opts.gameSummary){
          ...
          //             opts.itemsMargin/2;
          $('div#quizy-game-summary').css({top:'255px',left:'16%'}); //Changed position to specific(21-11)
  ...
  ****************************************************************************/
  ...
  $.fn.quizyMemoryGame.defaults = {itemWidth: 150, itemHeight: 150, itemsMargin:10, colCount:4, animType:'scroll', animSpeed:250, openDelay:2500, flipAnim:'rl', resultIcons:true, gameSummary:true, randomised:true, textSummaryTitle:'Result:', replayButton:true, replayButtonText:'Replay', closeButtonText:'Close', textSummaryClicks:'tries', textSummaryTime:'seconds', onFinishCall:''}
